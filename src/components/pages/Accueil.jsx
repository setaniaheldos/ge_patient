...
export default function Home() {
  ...
  useEffect(() => {
    ...
    axios.get('https://mon-api.onrender.com/praticiens').then(res => {
      setCounts(c => ({ ...c, praticiens: res.data.length }));
    });
    axios.get('https://mon-api.onrender.com/rendezvous').then(res => {
      setCounts(c => ({ ...c, rendezvous: res.data.length }));
    });
    axios.get('https://mon-api.onrender.com/consultations').then(res => {
      setCounts(c => ({ ...c, consultations: res.data.length }));
    });
    axios.get('https://mon-api.onrender.com/prescriptions').then(res => {
      setCounts(c => ({ ...c, prescriptions: res.data.length }));
    });
    axios.get('https://mon-api.onrender.com/patients').then(res => {
    ...
    axios.get('https://mon-api.onrender.com/utilisateurs').then(res => {
      setCounts(c => ({ ...c, utilisateurs: res.data.length }));
    }).catch(() => {
      // Fallback si la route /utilisateurs échoue
      axios.get('https://mon-api.onrender.com/users').then(res => {
        setCounts(c => ({ ...c, utilisateurs: res.data.length }));
      });
    });

    axios.get('https://mon-api.onrender.com/admins')
      .then(res => {
    ...
    if (userId) {
      ...
      axios.get(`https://mon-api.onrender.com/utilisateurs/${userId}`)
        .then(res => {
