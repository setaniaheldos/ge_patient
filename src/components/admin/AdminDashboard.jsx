...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      axios.get('https://mon-api.onrender.com/users')
    ])
  ...
  const handleDeleteAdmin = async (id, idx) => {
    ...
    try {
      await axios.delete(`https://mon-api.onrender.com/admins/${id}`);
  ...
  const handleDeleteUser = async (id) => {
    ...
    try {
      await axios.delete(`https://mon-api.onrender.com/users/${id}`);
